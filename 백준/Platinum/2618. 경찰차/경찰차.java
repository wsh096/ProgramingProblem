...
public class Main {
    ...
    private static int solution(int eventIdx, int oneIdx, int twoIdx) {
    ...
    private static int distance(int type, int startIdx, int endIdx) {
    ...
    private static int[] getStartPosition(int type, int idx) {
